...
class CustomNN_YArch(nn.Module):
    fun_name:Final[str]

    def __init__(self, sizes:list[list[int],list[int]],
                 activations:list[list[type[nn.Module]],list[type[nn.Module]]]|type[nn.Module]|None = None):
        ...
        self.fun_name=f'CustomNN_YArch-layers_{sizesCommon[0]}'
